...
<head>
  ...
  <link href="{{url('/icon/kit.png')}}" rel="icon">
...
<div class="wrapper" style="background-color: #ecf0f5;">
  ...
  <header class="main-header" style="position: fixed;width: 100%;">
    <!-- Logo -->
    <a href="#" class="logo">
      <span><img width="30px" src="{{url('icon/kit.png')}}"></span>
  ...
  <div class="content-wrapper" style="background: url(icon/map.jpg);min-height: 1649px;">
