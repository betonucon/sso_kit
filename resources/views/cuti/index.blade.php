                            ...
                            <table  id="example1" class="table table-bordered table-striped">
                                ...
                                @foreach(cuti_karyawan() as $no=>$data)
                                    <tr>
                                        ...
                                        <td><span class="btn btn-success btn-sm" data-toggle="modal" data-target="#modaledit{{$data->id}}"><i class="fa fa-pencil"></i></span>
                                            <span class="btn btn-danger btn-sm" onclick="hapus({{$data['id']}})"><i class="fa fa-remove"></i></span></td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
                        ...
                        <input type="hidden" name="tanggal_sebelumnya" value="{{$data['tanggal_cuti']}}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="tanggal_cuti" value="{{$data['tanggal_cuti']}}" class="form-control" id="datepickeredit{{$data->id}}" placeholder="Tanggal">
                                </div>
                            </div>
                            <div class="form-group">
                                <label>Alasan Cuti</label>
                                <textarea name="name" class="form-control" rows="4" style="width:100%;">{{$data['name']}}</textarea>
                            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="display:flex">
                <div class="row" style="width:96%;margin-left:2%">
                    ...
                    <div class="col-md-6" style="background: #cbcdff;padding: 2%;">
                        ...
                        <form method="post" id="mysimpan_data" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" disabled value="{{sisa_cuti()}}" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>Mulai</label>
                                    <div class="input-group">
